        ...
        <aside className="profile-menu">
            ...
            <ul className="clean-list profile-scroll">
                <li className="menu-item" onClick={() => closeProfileMenu()}>
                    ...
                    <NavLink className="clean-link" to={`/user/${user._id}`}>Profile</NavLink></li>
                <li className="menu-item" onClick={() => closeProfileMenu()}>
                    {/* currently /user/${user._id} instead of dashboard/${user._id} */}
                    <NavLink
                        className="clean-link" to={`/user/${user._id}`}>Dashboard</NavLink></li>
                <li className="menu-item logout" onClick={() => onLogout()}><NavLink className="clean-link" to={`/`}>Logout</NavLink></li>
            </ul>
        </aside>
    )
}